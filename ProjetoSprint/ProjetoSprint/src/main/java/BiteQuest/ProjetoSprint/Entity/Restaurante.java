...
public class Restaurante {
    ...
    private String cnpj;
    private org.example.entity.Endereco endereco;
    private List<Cardapio> cardapios;

    public Restaurante(String descricao, String horarioFuncionamento, String cnpj, org.example.entity.Endereco endereco) {
    ...
    public org.example.entity.Endereco getEndereco() {
        return endereco;
    }
